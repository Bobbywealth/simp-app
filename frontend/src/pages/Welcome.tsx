    ...
    <div className="relative flex min-h-screen flex-col items-center justify-between bg-ink-950 text-white">
      ...
      <main className="relative z-10 flex w-full max-w-md flex-1 flex-col items-center justify-center px-6 text-center">
        ...
        <motion.h1
          ...
          className="display-heading text-5xl font-light tracking-[0.35em] text-gold-gradient"
        >
          SIMP
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-3 text-[11px] font-medium uppercase tracking-[0.45em] text-gold-300/80"
        >
