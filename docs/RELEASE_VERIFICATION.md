...
| Frontend HTTP root (HTTPS)                | green  | `GET https://simp-web.onrender.com/` returned 200 + valid HTML                                            |
...
- `ALLOWED_ORIGINS=https://simp-web.onrender.com` (HTTPS-only)
- `PUBLIC_BASE_URL=https://simp-backend-b8nz.onrender.com`
- `FRONTEND_URL=https://simp-web.onrender.com`
...
- `App.entitlements` validates with `plutil -lint` (`aps-environment`, `applinks:simp.app`).
