...
SIMP IS FULLY FREE
Free tier: 25 daily likes, 1 super-like per day, browse and match verified members. Reorder and reply from your incoming likes inbox, advanced filters (verified-only, interests, distance), rewind your last swipe — all included.

There are no paid tiers. There is no SIMP+ or SIMP Elite. No in-app purchases, no subscriptions.
...
-—
SIMP is for adults 18+. Photo verification and human moderation keep the community safe. SIMP is fully free — no subscriptions, no in-app purchases. Terms: mysimp.com/terms. Privacy: mysimp.com/privacy.
```
...
• Fully free — no subscriptions, no in-app purchases, no premium tier
